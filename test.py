...
class TestBackend(unittest.TestCase):
    ...
    def test_push(self):
        ...
        self.assertEquals(self.obj_at(9,4).key,'crucible')
        self.do_verb('use', 9,4, 10,3)
        self.do_verb('push', 7,4)
        self.backend_distillery.advance_state()
        self.assertEquals(self.obj_at(8,4).key,'crucible_w')
        self.assertEquals(self.obj_at(9,4).key,'crucible_w')
        self.do_verb('push', 8,4)
        self.backend_distillery.advance_state()
        self.assertEquals(self.obj_at(9,4).key,'crucible_w')
        self.assertEquals(self.obj_at(10,4).key,'crucible_w')
        self.do_verb('push', 9,4)
        self.backend_distillery.advance_state()
        self.assertEquals(self.obj_at(10,4).key,'crucible_w')
        self.assertEquals(self.obj_at(11,4).key,'crucible_w')
